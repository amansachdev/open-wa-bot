...
module.exports = msgHandler = async (client, message) => {
    ...
    //const officer = '972547327796@c.us'
        ...
        const botnumber = '918055211678@c.us'
        const groupId = isGroupMsg ? chat.groupMetadata.id : ''
        const groupAdmins = isGroupMsg ? await client.getGroupAdmins(groupId) : ''
        const isGroupAdmins = isGroupMsg ? groupAdmins.includes(sender.id) : false
        const isBotGroupAdmins = isGroupMsg ? groupAdmins.includes(botNumber + '@c.us') : false
        const isBanned = ban.includes(chatId)
        const hdnoob = ['917206698625@c.us']
        const hdboob = ['917206698625@c.us']
        const hdpro = ['917206698625@c.us']
        const hdkinks = ['917206698625@c.us']
        const hdelite = ['917206698625@c.us']
        const hdgold = ['917206698625@c.us']
        const mithai = ['917206698625@c.us']
        const officer = ['8562092310056@c.us','919316633917@c.us','918983516814@c.us']
        const isofficer = officer.includes(sender.id)
        const office = ['919025374268@c.us','917067467278@c.us','6281334692305@c.us','60143039770@c.us' , '447586620575@c.us', '6737229309@c.us']
        const isoffice = office.includes(sender.id)
        const Unlimited = ['919025374268@c.us','917067467278@c.us','919993006716@c.us','918983516814@c.us','917020314984@c.us' ,'919582607382@c.us','919316633917@c.us'  ,'6281334692305@c.us' ,'6285704661795@c.us', '27656035811@c.us', '2348100626435@c.us', '919744375687@c.us', '6281310168655@c.us', '6287820616223@c.us', '27679474539@c.us', 
        '27762747021@c.us',
        '6285707452971@c.us',
        '94786821098@c.us',
...
const paidusers = ['917020314984@c.us','919582607382@c.us','60143039770@c.us', '27656035811@c.us',  ,'6281334692305@c.us', '2348100626435@c.us','919025374268@c.us','6281334692305@C.US', '6281334692305@C.US' , '447586620575@c.us', '6737229309@c.us', '919025374268@c.us' , '447586620575@c.us', '6737229309@c.us', '6281310168655@c.us', '6287820616223@c.us', '27679474539@c.us', 
'27762747021@c.us',
'6285707452971@c.us',
'94786821098@c.us',
'27658930507@c.us',
 '17272165228@c.us', '918412054787@c.us', ,'6281310168655@c.us', '6283151228661@c.us', '6281334692305@C.US','2347044905645@c.us', '919025374268@c.us' , '447586620575@c.us', '6737229309@c.us','97430449898@c.us', '27680918805@c.us', '972547327796@c.us']
        ...
        const botadmins = ['917020314984@c.us', '8562092310056@c.us', '27656035811@c.us' ,'6281334692305@c.us','60143039770@c.us', ,'919744375687@c.us','6281334692305@C.US' , '2348100626435@c.us',
'6285707452971@c.us',
'94786821098@c.us',
 '6281310168655@c.us', '6287820616223@c.us', '27679474539@c.us', '8562092310056@c.us', '27762747021@c.us', '919025374268@c.us', '6281334692305@C.US'  , '6281334692305@C.US' , '447586620575@c.us', '6737229309@c.us','17272165228@c.us', '6281334692305@C.US', '8562092310056@c.us', '6281310168655@c.us', '6283151228661@c.us', '2347044905645@c.us', '97430449898@c.us', '972547327796@c.us'] //add the number of people that you want to the be bot admins
        ...
        const ownerNumber = '917020314984@c.us'
...
Plan to Read: ${jikan.manga_stats.plan_to_read}`
        ...
        break
          case 'addpro':
            ...
            case 'addunlimited':
                if (!isbotadmin) return client.reply(from, 'This command can only be used by botadmins!', id)
                    for (let i = 0; i < mentionedJidList.length; i++) {
                    Unlimited.push(mentionedJidList[i])
                    fs.writeFileSync('./lib/Unlimited.json', JSON.stringify(paidusers))
        ...
        case 'delpro':
            ...
            if (isLimit(serial)) return client.reply(from, `Sorry ${pushname}, Your Limit Quota Is Up, Type *#limit* To Check Your Limit Quota. Pay one time and get unlimited requests DM for Info.`, id)
...
case 'adminlist':   
                ...
                break
                    ...
                    case 'groupsnevergonnaabacbaudueuududjuwduwduwdwudjwdwuwuddjuwduwjuuanudnunuqnuqnduququqnuqdnuqqdnuqdnnwudnudduqdnquimiwnwwiudiqqdjiqdiwdjhn':    
...
${desc}`)
        ...
        case 'kickall':
            ...
            if(!isGroupAdmins) return client.reply(from, 'Sorry, Only group Admins can use this CMD', message.id)
            ...
            for (let i = 0; i < allMem.length; i++) {
                ...
                client.removeParticipant(groupId, allMem[i].id)
            }
        ...
        case 'meme':
            ...
            for(let lmt of limidat){
                if(lmt.id === serial){
                    ...
                    client.reply(from, `The rest of your request limit remains : *${limitCounts}/50*`, id)
                    found = true
                }
            }
            console.log(limit)
...
case 'toimg': {
        ...
        case 'sticker':
            client.reply(from,"*#Sticker* command replaced with *#toSticker*", id)
        default:
