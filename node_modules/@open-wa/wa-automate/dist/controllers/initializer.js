...
exports.create = exports.screenshot = void 0;
var fs = require('fs'), boxen = require('boxen'), osName = require('os-name'), configWithCases = require('../../bin/config-schema.json'), updateNotifier = require('update-notifier'), pkg = require('../../package.json'), timeout = function (ms) {
...
function create(config) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var START_TIME, waPage, notifier, sessionId, customUserAgent, result, prettyFont, popupaddr, spinner, throwOnError, PAGE_UA, BROWSER_VERSION, OS, START_TS, screenshotPath_1, WA_AUTOMATE_VERSION, WA_VERSION, canInjectEarly, debugInfo, authRace, authenticated, outOfReach, race, result, pre, VALID_SESSION, localStorage_1, _a, _b, sessionjsonpath, sessionData, sdB64, pureWAPI, _c, data, LAUNCH_TIME_MS, client, me, l_err, data, l_success, keyType, error_1;
        var _this = this;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 8:
                    ...
                    OS = osName();
                    START_TS = Date.now();
                    screenshotPath_1 = "./logs/" + (config.sessionId || 'session') + "/" + START_TS;
                    exports.screenshot = function (page) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, page.screenshot({
                                        path: screenshotPath_1 + "/" + Date.now() + ".jpg"
                                    }).catch(function (_) {
                                ...
                                case 1:
                                    _a.sent();
                                    console.log('Screenshot taken. path:', "" + screenshotPath_1);
                                    return [2];
                            }
                        });
                    }); };
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (!(msg.type() === 'error' && !msg.text().includes('apify') && !msg.text().includes('crashlogs'))) return [3, 2];
                                        return [4, exports.screenshot(waPage)];
                                    case 1:
                                        _a.sent();
                                        _a.label = 2;
                                    case 2: return [2];
                    ...
                    return [4, waPage.waitForFunction('window.Debug!=undefined && window.Debug.VERSION!=undefined')];
                case 9:
                    _d.sent();
                ...
                case 15:
                    ...
                    if (!(authenticated == 'timeout')) return [3, 18];
                ...
                case 24:
                    ...
                    if (!canInjectEarly) return [3, 26];
                    spinner.start('Checking if session is valid');
                    if (!(config === null || config === void 0 ? void 0 : config.safeMode)) return [3, 26];
                    return [4, timeout(5000)];
                case 25:
                    _d.sent();
                    _d.label = 26;
                case 26: return [4, waPage.evaluate(function () { return window.Store && window.Store.Msg ? true : false; })];
                case 27:
                    VALID_SESSION = _d.sent();
                    if (!VALID_SESSION) return [3, 53];
                ...
                case 30:
                    _c.NUM = _d.sent();
                    if (!(config === null || config === void 0 ? void 0 : config.hostNotificationLang)) return [3, 32];
                    return [4, waPage.evaluate("window.hostlang=\"" + config.hostNotificationLang + "\"")];
                case 31:
                    _d.sent();
                    _d.label = 32;
                case 32:
                    if (!!(config === null || config === void 0 ? void 0 : config.skipPatches)) return [3, 37];
                    spinner.info('Installing patches');
                    if (!!axios) return [3, 34];
                    return [4, Promise.resolve().then(function () { return __importStar(require('axios')); })];
                case 33:
                    axios = _d.sent();
                    _d.label = 34;
                case 34: return [4, axios.get(pkg.patches)];
                case 35:
                    data = (_d.sent()).data;
                ...
                case 36:
                    ...
                    _d.label = 37;
                case 37:
                    if (!((config === null || config === void 0 ? void 0 : config.skipBrokenMethodsCheck) !== true)) return [3, 39];
                ...
                case 40:
                    me = (_d.sent()).me;
                    if (!(config === null || config === void 0 ? void 0 : config.licenseKey)) return [3, 51];
                    if (!!axios) return [3, 42];
                    return [4, Promise.resolve().then(function () { return __importStar(require('axios')); })];
                case 41:
                    axios = _d.sent();
                    _d.label = 42;
                ...
                case 44:
                    l_success = _d.sent();
                    if (!!l_success) return [3, 46];
                    return [4, waPage.evaluate('window.launchError')];
                case 45:
                    l_err = _d.sent();
                    return [3, 48];
                case 46: return [4, waPage.evaluate('window.KEYTYPE || false')];
                case 47:
                    keyType = _d.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4, (p === null || p === void 0 ? void 0 : p.close())];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
                if (!browser) return [3, 5];
                return [4, (browser === null || browser === void 0 ? void 0 : browser.close().catch(function () { }))];
            case 4:
                _a.sent();
                _a.label = 5;
            case 5:
