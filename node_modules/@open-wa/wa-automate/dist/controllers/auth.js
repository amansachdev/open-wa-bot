...
exports.isAuthenticated = function (waPage) { return rxjs_1.race(exports.needsToScan(waPage), exports.isInsideChat(waPage)).toPromise(); };
...
function smartQr(waPage, config) {
    return __awaiter(this, void 0, void 0, function () {
        var evalResult, isAuthed, grabAndEmit, qrEv, _hasDefaultStateYet;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    qrEv = new events_1.EvEmitter(config.sessionId || 'session', 'qr');
                    return [4, waPage.evaluate("window.Store &&  window.Store.State && window.Store.State.default")];
                case 3:
                    _hasDefaultStateYet = _a.sent();
                    if (!!_hasDefaultStateYet) return [3, 5];
                    return [4, timeout(2000)];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5: return [2, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4, waPage.exposeFunction(funcName, function (obj) { return fn(obj); }).then(set).catch(function (e) { return __awaiter(_this, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4, initializer_1.screenshot(waPage)];
                                                    case 1:
                                                        _a.sent();
                                                        console.log("qr -> e", e);
                                                        return [2];
