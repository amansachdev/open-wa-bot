...
export declare class Client {
    ...
    download(url: string, optionsOverride?: any): Promise<string>;
    ...
    onParticipantsChanged(groupId: GroupChatId, fn: (participantChangedEvent: ParticipantChangedEventModel) => void, legacy?: boolean): Promise<any>;
    ...
    forceUpdateConnectionState(): Promise<string>;
    ...
    sendImage(to: ChatId, file: DataURL | FilePath, filename: string, caption: Content, quotedMsgId?: MessageId, waitForId?: boolean, ptt?: boolean, withoutPreview?: boolean): any;
    ...
    sendFile(to: ChatId, file: DataURL | FilePath, filename: string, caption: Content, quotedMsgId?: MessageId, waitForId?: boolean, ptt?: boolean, withoutPreview?: boolean): any;
    ...
    sendFileFromUrl(to: ChatId, url: string, filename: string, caption: Content, quotedMsgId?: MessageId, requestConfig?: any, waitForId?: boolean, ptt?: boolean, withoutPreview?: boolean): any;
    getMe(): Promise<any>;
    ...
    sendMp4AsSticker(to: ChatId, file: DataURL | Buffer | Base64 | string, processOptions?: {
        fps?: number;
        startTime?: string;
        endTime?: string;
        loop?: number;
    ...
    setChatEphemeral(chatId: ChatId, ephemeral: boolean): Promise<any>;
    ...
    listWebhooks(): Promise<SimpleListener[]>;
    removeWebhook(simpleListener: SimpleListener): Promise<boolean>;
